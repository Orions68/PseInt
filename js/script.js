function calculate() // Función calculate, la llama el botón Calcula el Resultado.
{
    ...
    result.innerHTML= "El Resultado Es: " + eval(input.value + select.value + input2.value); // Muestra el resutlado en el h3 mediante la funvión eval que transforma todos los parámetro en objetos, así el valor que hay en el primer input es un número, el valor que hay en el segundo input es otro número y el contenido del select es un caracter que si es el * multiplica los dos números de los inputs, si es el caracter + los suma, el - los resta y el / los divide.
}